...
TABLE = "serpapi_google_patents_cache"

SECTION_COLS = {"search_information", "organic_results", "summary", "pagination", "serpapi_pagination"}
_STRIP_KEYS = {"search_metadata", "search_parameters"}


def build_params(search_phrase, country, language, location, pages, cluster=False):
    p = {
