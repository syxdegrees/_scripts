...
SCRIPT = str(Path(__file__).parent / 'customer_discovery_url_voc_extraction.py')
...
from customer_discovery_url_voc_extraction import deduplicate_by_url
...
from customer_discovery_url_voc_extraction import run_summary
...
def test_run_summary_output(capsys):
    ...
    with patch('customer_discovery_url_voc_extraction.fetch_serp_results', return_value=rows):
...
from customer_discovery_url_voc_extraction import fetch_firecrawl
...
def test_fetch_firecrawl_returns_markdown():
    ...
    with patch('customer_discovery_url_voc_extraction.requests.post', return_value=mock_resp):
...
from customer_discovery_url_voc_extraction import extract_voc, strip_fences
...
from customer_discovery_url_voc_extraction import save_voc_content, VOC_TABLE, JUNCTION_TABLE
...
def test_save_voc_content_inserts_in_position_order():
    ...
    with patch('customer_discovery_url_voc_extraction.requests.post', side_effect=mock_post):
...
from customer_discovery_url_voc_extraction import run_extract
